...
public class MarvinImage implements Cloneable {
	 ...
	 * @param a_x		- rect�s start position in x-axis
	 * @param a_y		- rect�s start positioj in y-axis
	 * @param a_width	- rect�s width
	 * @param a_height	- rect�s height
	 * @param a_color	- rect�s color
	 */
