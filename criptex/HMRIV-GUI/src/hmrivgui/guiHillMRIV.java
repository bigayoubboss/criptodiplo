...
import cpcommonmethods.ArraysUtils;
import imageProcesing.ImageProcessing;
...
public class guiHillMRIV extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        botonCargarClave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/cargar.png"))); // NOI18N
        ...
        botonVisualizarClave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/ver.png"))); // NOI18N
        ...
        botonGenerarClave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/clave.png"))); // NOI18N
        ...
        botonCifrarHill.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/cifrar.png"))); // NOI18N
        ...
        botonCifrarHillMRIV.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/cifrarAlt.png"))); // NOI18N
        ...
        botonLimpiarImagenHillMRIV.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/reiniciar.png"))); // NOI18N
        ...
        botonGuardarImagenHillMRIV.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/guardar.png"))); // NOI18N
        ...
        cargarImagenHillMRIV.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/stepIII.png"))); // NOI18N
        ...
        cargarImagenHill.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/stepII.png"))); // NOI18N
        cargarImagenHill.setBounds(215, 30, 190, 190);
        panelimagenes.add(cargarImagenHill, javax.swing.JLayeredPane.DEFAULT_LAYER);

        botonLimpiarImagenHill.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/reiniciar.png"))); // NOI18N
        ...
        botonGuardarImagenHill.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/guardar.png"))); // NOI18N
        ...
        botonLimpiarImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/reiniciar.png"))); // NOI18N
        ...
        cargarImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/stepI.png"))); // NOI18N
        ...
        botonGuardarImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/guardar.png"))); // NOI18N
        ...
        botonAbrirImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/abrir.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/fondoTituloHillMRIV.png"))); // NOI18N
    ...
    private void cargarImagenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cargarImagenActionPerformed
        ...
        try {
            if (archivo.isFile()) {
                ...
                cargarImagen.setIcon(new javax.swing.ImageIcon(imageProcesing.ImageProcessing.RGBImageToMarvinImage(imageResize).getBufferedImage()));
            }
    ...
    private void botonCifrarHillActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonCifrarHillActionPerformed
        ...
        if (p.exists()) {
            ...
            try {
                ...
                jama.Matrix key = loadKey();
                if (key != null) {
                    int[] encryptImageHill;
                    for (int x = 0; x < 3; x++) {
                        encryptImageHill = ImageCryptography.HillMRIVCipher.encryptHill(ArraysUtils.array2DTo1D(image[x]), key);
                    ...
                    cargarImagenHill.setIcon(new javax.swing.ImageIcon(imageProcesing.ImageProcessing.RGBImageToMarvinImage(imageResize).getBufferedImage()));
                } else {
        ...
        if (p.exists()) {
            ...
            try {
                ...
                if (iv != null) {
                    ...
                    if (key != null) {
                        for (int x = 0; x < 3; x++) {
                            encryptImageHillMRIV = ImageCryptography.HillMRIVCipher.encryptHillMRIV(ArraysUtils.array2DTo1D(image[x]), iv, key);
                        ...
                        cargarImagenHillMRIV.setIcon(new javax.swing.ImageIcon(imageProcesing.ImageProcessing.RGBImageToMarvinImage(imageResize).getBufferedImage()));
                    } else {
                        System.out.println("Clave no encontrada");
                    }
                } else {
    ...
    private void botonLimpiarImagenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonLimpiarImagenActionPerformed
        // TODO add your handling code here:
        cargarImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/stepI.png")));
        File p = new File("Images\\Original.jpg");
        if (p.exists()) {
            p.delete();
        }
    ...
    private void botonLimpiarImagenHillActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonLimpiarImagenHillActionPerformed
        // TODO add your handling code here:
        cargarImagenHill.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/stepII.png")));
    ...
    private void botonLimpiarImagenHillMRIVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonLimpiarImagenHillMRIVActionPerformed
        // TODO add your handling code here:
        cargarImagenHillMRIV.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/stepIII.png")));
    ...
    private jama.Matrix loadKey() {
        jama.Matrix key = null;
        int[] numeros;
        File archivo = new File(cajaRutaArchivo.getText());
        if (archivo.isFile()) {
            try {
                ...
                int[][] keyInt = cpcommonmethods.ArraysUtils.array1DTo2D(numeros);
                for (int x = 0; x < m; x++) {
                    for (int y = 0; y < m; y++) {
    ...
    private static jama.Matrix generateKey(int m) {
        jama.Matrix key = new jama.Matrix(m, m);
        Random rnd = new Random();
