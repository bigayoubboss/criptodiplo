...
public class SimplifiedDESCipher {
    ...
    public static String[][] bruteForce(String text) {
        ...
        for (int x = 0; x < 1024; x++) {
            ...
            posibilities[x][1] = cpcommonmethods.HexTools.fromHexStringToASCIIString(plainText);
        }
        return posibilities;
    ...
    private static int[][] keySchedulingAlgorithm(String binKeyString) {
        ...
        int[] keyBin = cpcommonmethods.HexTools.fromBinStringToBinArray(binKeyString);
