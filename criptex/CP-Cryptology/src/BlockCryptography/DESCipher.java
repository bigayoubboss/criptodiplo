...
public class DESCipher {
    ...
    private static int[] textSchedulingAlgorithm(String text, int[][] keys, boolean mode) {
        ...
        for (int x = 1; x < 17; x++) {
            ...
            for (int y = 0; y < 48; y = y + 6) {
                sBoxesValues[box - 1] = boxS(xorKeyAndRight[y], xorKeyAndRight[y + 1],
                        xorKeyAndRight[y + 2], xorKeyAndRight[y + 3], xorKeyAndRight[y + 4], xorKeyAndRight[y + 5], box);
                box++;
            }
            ...
            for (int y = 0; y < 32; y++) {
                System.out.print(rightText[x][y]);
            }
        }
    ...
    private static int[][] keySchedulingAlgorithm(String keyString) {
        ...
        int[] keyBin = cpcommonmethods.HexTools.fromHexStringToBinArray(keyString);
    ...
    public static int[] boxS(int v1, int v2, int v3, int v4, int v5, int v6, int box) {

        int rowIndex = Integer.parseInt(String.valueOf(v1).concat(String.valueOf(v6)), 2);
        int colIndex = Integer.parseInt(String.valueOf(v2).concat(String.valueOf(v3)).concat(String.valueOf(v4).concat(String.valueOf(v5))), 2);
        int boxValue = 0;
        switch (box) {
            case 1:
