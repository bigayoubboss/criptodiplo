...
public class gui extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		fondoTitulo.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/fondoTitulo.png"))); // NOI18N
		...
		panelContenido.add(tituloCifrado,
		...
		panelContenido.add(panelTextoPlano,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		...
		panelContenido.add(panelTextoCifrado,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonSalir.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/salir.png"))); // NOI18N
		...
		botonEncriptar.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/cifrar.png"))); // NOI18N
		...
		panelContenido.add(botonEncriptar,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonCriptoanalisis.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/criptoanalisis.png"))); // NOI18N
		...
		panelContenido.add(botonCriptoanalisis,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonAcercaDe.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/creditos.png"))); // NOI18N
		...
		panelContenido.add(botonAcercaDe,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonAbrirCifrado.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/abrir.png"))); // NOI18N
		...
		panelContenido.add(botonAbrirCifrado,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonGuardarCifrado.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/guardar.png"))); // NOI18N
		...
		panelContenido.add(botonGuardarCifrado,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonAbrirPlano.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/abrir.png"))); // NOI18N
		...
		panelContenido.add(botonAbrirPlano,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonLimpiarCifrado.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/limpiar.png"))); // NOI18N
		...
		panelContenido.add(botonLimpiarCifrado,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonGuardarPlano.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/guardar.png"))); // NOI18N
		...
		panelContenido.add(botonGuardarPlano,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonLimpiarPlano1.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/limpiar.png"))); // NOI18N
		...
		panelContenido.add(botonLimpiarPlano1,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		...
		panelMetodoDesplazamiento.setBackground(new java.awt.Color(232, 232,
				232));
		...
		textoFuncionamientoDesplazamiento.setCursor(new java.awt.Cursor(
		...
		textoFuncionamientoDesplazamiento.setBounds(25, 51, 90, 58);
		panelMetodoDesplazamiento.add(textoFuncionamientoDesplazamiento,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		textoTipoCifradoDesplazamiento.setText("Tipo de cifrado:");
		textoTipoCifradoDesplazamiento.setCursor(new java.awt.Cursor(
				java.awt.Cursor.DEFAULT_CURSOR));
		...
		panelMetodoDesplazamiento.add(textoTipoCifradoDesplazamiento,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		textoTipoCifradoDesplazamientoT
				.setText("Monoalfabético por desplazamiento (z189)");
		textoTipoCifradoDesplazamientoT.setCursor(new java.awt.Cursor(
				java.awt.Cursor.DEFAULT_CURSOR));
		...
		textoTipoCifradoDesplazamientoT.setBounds(117, 29, 270, 20);
		panelMetodoDesplazamiento.add(textoTipoCifradoDesplazamientoT,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		textoDescripcionDesplazamiento.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		textoDescripcionDesplazamiento
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		textoDescripcionDesplazamiento
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		textoDescripcionDesplazamiento.setCursor(new java.awt.Cursor(
				java.awt.Cursor.DEFAULT_CURSOR));
		...
		textoDescripcionDesplazamientoT.setBackground(new java.awt.Color(232,
				232, 232));
		textoDescripcionDesplazamientoT.setColumns(20);
		textoDescripcionDesplazamientoT.setEditable(false);
		textoDescripcionDesplazamientoT.setFont(new java.awt.Font("Tahoma", 0,
				11)); // NOI18N
		textoDescripcionDesplazamientoT.setLineWrap(true);
		textoDescripcionDesplazamientoT.setRows(5);
		textoDescripcionDesplazamientoT
				.setText("Al cifrar, cada letra del texto plano es reemplazada por la k-ésima letra del alfabeto que le sigue en orden, siendo k la clave utilizada. El paso de texto cifrado a plano es realizado por FUERZA BRUTA.");
		...
		textoDescripcionDesplazamiento
				.setViewportView(textoDescripcionDesplazamientoT);

		textoDescripcionDesplazamiento.setBounds(117, 50, 265, 61);
		panelMetodoDesplazamiento.add(textoDescripcionDesplazamiento,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonClaveDesplazamiento.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/clave.png"))); // NOI18N
		botonClaveDesplazamiento.setText("Generar una clave");
		botonClaveDesplazamiento
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		panelMetodoDesplazamiento.add(botonClaveDesplazamiento,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelTipoClaveDesplazamiento.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Ingrese la clave",
						javax.swing.border.TitledBorder.LEFT,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		panelTipoClaveDesplazamiento.setFocusable(false);

		claveDesplazamientoNumero
		...
		tipoClaveDesplazamientoCaracter
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		javax.swing.GroupLayout panelTipoClaveDesplazamientoLayout = new javax.swing.GroupLayout(
				panelTipoClaveDesplazamiento);
		panelTipoClaveDesplazamiento
				.setLayout(panelTipoClaveDesplazamientoLayout);
		panelTipoClaveDesplazamientoLayout
				.setHorizontalGroup(panelTipoClaveDesplazamientoLayout
						.createParallelGroup(
						...
						.addGroup(
								panelTipoClaveDesplazamientoLayout
										...
										.addContainerGap()));
		panelTipoClaveDesplazamientoLayout
				.setVerticalGroup(panelTipoClaveDesplazamientoLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelTipoClaveDesplazamientoLayout
		...
		panelMetodoDesplazamiento.add(panelTipoClaveDesplazamiento,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMuestraDesplazamiento.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null,
						"El alfabeto original será desplazado",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		panelMuestraDesplazamiento.setFocusable(false);

		labelMuestraDesplazamientoDe
		...
		muestraDesplazamientoA
				.setHorizontalAlignment(javax.swing.JTextField.CENTER);

		javax.swing.GroupLayout panelMuestraDesplazamientoLayout = new javax.swing.GroupLayout(
				panelMuestraDesplazamiento);
		panelMuestraDesplazamiento.setLayout(panelMuestraDesplazamientoLayout);
		panelMuestraDesplazamientoLayout
				.setHorizontalGroup(panelMuestraDesplazamientoLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								...
								panelMuestraDesplazamientoLayout
										...
										.addContainerGap()));
		panelMuestraDesplazamientoLayout
				.setVerticalGroup(panelMuestraDesplazamientoLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
		...
		panelMetodoDesplazamiento.add(panelMuestraDesplazamiento,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelDescripcionDesplazamiento.setBorder(null);
		panelDescripcionDesplazamiento
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDescripcionDesplazamiento
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		...
		panelDescripcionDesplazamiento.setPreferredSize(new java.awt.Dimension(
				370, 110));
		...
		cajaDescripcionDesplazamiento.setBackground(new java.awt.Color(232,
				232, 232));
		...
		cajaDescripcionDesplazamiento.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Descripción",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		panelDescripcionDesplazamiento
				.setViewportView(cajaDescripcionDesplazamiento);

		panelDescripcionDesplazamiento.setBounds(10, 10, 380, 110);
		panelMetodoDesplazamiento.add(panelDescripcionDesplazamiento,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelResultadosDesplazamiento.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Resultados",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		tablaResultadosDesplazamiento
				.setModel(new javax.swing.table.DefaultTableModel(
						new Object[][] { { null } },
						new String[] { "Resultados" }) {
		...
		contenedorResultadosDesplazamiento
				.setViewportView(tablaResultadosDesplazamiento);

		textoMasProbablesClavesDesplazamiento
				.setText("Según el análisis de frecuencia la clave mas probable es:");
		textoMasProbablesClavesDesplazamiento.setFocusable(false);
		textoMasProbablesClavesDesplazamiento.setInheritsPopupMenu(false);

		textoMasProbablesClavesDesplazamientoR.setFont(new java.awt.Font(
				"Tahoma", 1, 11));
		...
		tablaResultadosDesplazamientoBigramas
				.setModel(new javax.swing.table.DefaultTableModel(
						new Object[][] { { null } },
						new String[] { "Resultados" }) {
					boolean[] canEdit = new boolean[] { false };
		...
		contenedorResultadosDesplazamientoBigramas
				.setViewportView(tablaResultadosDesplazamientoBigramas);

		tablaResultadosDesplazamientoTrigramas.setAutoCreateRowSorter(true);
		tablaResultadosDesplazamientoTrigramas
				.setModel(new javax.swing.table.DefaultTableModel(
						new Object[][] { { null } },
						new String[] { "Resultados" }) {
					boolean[] canEdit = new boolean[] { false };
		...
		contenedorResultadosDesplazamientoTrigramas
				.setViewportView(tablaResultadosDesplazamientoTrigramas);

		javax.swing.GroupLayout panelResultadosDesplazamientoLayout = new javax.swing.GroupLayout(
				panelResultadosDesplazamiento);
		panelResultadosDesplazamiento
				.setLayout(panelResultadosDesplazamientoLayout);
		panelResultadosDesplazamientoLayout
				.setHorizontalGroup(panelResultadosDesplazamientoLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelResultadosDesplazamientoLayout
														...
														.addGroup(
																panelResultadosDesplazamientoLayout
																		...
																		.addPreferredGap(
																				javax.swing.LayoutStyle.ComponentPlacement.RELATED)
																		.addComponent(
																				textoMasProbablesClavesDesplazamientoR,
																				javax.swing.GroupLayout.PREFERRED_SIZE,
																				58,
																				javax.swing.GroupLayout.PREFERRED_SIZE)))
										.addContainerGap()));
		panelResultadosDesplazamientoLayout
				.setVerticalGroup(panelResultadosDesplazamientoLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
		...
		panelMetodoDesplazamiento.add(panelResultadosDesplazamiento,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		textoDescripcionDesplazamiento1.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		textoDescripcionDesplazamiento1
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		textoDescripcionDesplazamiento1
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		...
		textoDescripcionDesplazamientoT1.setBackground(new java.awt.Color(232,
				232, 232));
		textoDescripcionDesplazamientoT1.setColumns(20);
		textoDescripcionDesplazamientoT1.setEditable(false);
		textoDescripcionDesplazamientoT1.setFont(new java.awt.Font("Tahoma", 0,
				11));
		textoDescripcionDesplazamientoT1.setLineWrap(true);
		textoDescripcionDesplazamientoT1.setRows(5);
		textoDescripcionDesplazamientoT1
				.setText("Cada letra del texto plano es reemplazada por la \nk-ésima letra del alfabeto que le sigue en orden. \nSiendo k la clave utilizada.");
		textoDescripcionDesplazamientoT1.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		...
		textoDescripcionDesplazamiento1
				.setViewportView(textoDescripcionDesplazamientoT1);

		textoDescripcionDesplazamiento1.setBounds(120, 60, 255, 50);
		panelMetodoDesplazamiento.add(textoDescripcionDesplazamiento1,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonLimpiarDesplazamiento.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/reiniciar.png"))); // NOI18N
		botonLimpiarDesplazamiento.setToolTipText("Limpiar o reiniciar clave");
		botonLimpiarDesplazamiento
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		botonLimpiarDesplazamiento
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		panelMetodoDesplazamiento.add(botonLimpiarDesplazamiento,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMetodosClasicos.addTab(
				"Desplazamiento",
				new javax.swing.ImageIcon(getClass().getResource(
						"/images/clasico.png")), panelMetodoDesplazamiento); // NOI18N

		panelMetodoSustitucion.setName("sustitucion"); // NOI18N

		botonClaveSustitucion.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/clave.png"))); // NOI18N
		botonClaveSustitucion.setText("Generar una clave");
		botonClaveSustitucion
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		panelMetodoSustitucion.add(botonClaveSustitucion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		...
		panelMetodoSustitucion.add(textoTipoCifradoSustitucion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		...
		panelMetodoSustitucion.add(textoFuncionamientoSustitucion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		textoTipoCifradoSustitucionT
				.setText("Monoalfabético por sustitución (z26)");
		...
		panelMetodoSustitucion.add(textoTipoCifradoSustitucionT,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		textoDescripcionSustitucion.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		textoDescripcionSustitucion
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		textoDescripcionSustitucion
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		...
		textoDescripcionSustitucionT.setBackground(new java.awt.Color(232, 232,
				232));
		textoDescripcionSustitucionT.setColumns(20);
		textoDescripcionSustitucionT.setEditable(false);
		textoDescripcionSustitucionT
				.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
		textoDescripcionSustitucionT.setLineWrap(true);
		textoDescripcionSustitucionT.setRows(5);
		textoDescripcionSustitucionT
				.setText("Al cifrar, cada letra del texto plano es reemplazada por el símbolo que ocupa la misma posición en la clave seleccionada. El paso de texto cifrado a plano es MANUAL.");
		textoDescripcionSustitucionT.setWrapStyleWord(true);
		textoDescripcionSustitucionT.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		...
		textoDescripcionSustitucion
				.setViewportView(textoDescripcionSustitucionT);

		textoDescripcionSustitucion.setBounds(117, 50, 265, 61);
		panelMetodoSustitucion.add(textoDescripcionSustitucion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMuestraSustitucion.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null,
						"El alfabeto original será sustituido",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		panelMuestraSustitucion.setFocusable(false);

		labelMuestraSustitucionDe
				.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
		...
		textoSustitucionDes.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		textoSustitucionDes
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		textoSustitucionDes
		...
		textoSustitucionDesT
				.setText("Ingrese la clave de acuerdo a como desee la sustitución del alfabeto.");
		textoSustitucionDesT.setWrapStyleWord(true);
		textoSustitucionDesT.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		textoSustitucionDesT.setFocusable(false);
		textoSustitucionDesT.setOpaque(false);
		textoSustitucionDesT.setPreferredSize(new java.awt.Dimension(155, 65));
		...
		javax.swing.GroupLayout panelMuestraSustitucionLayout = new javax.swing.GroupLayout(
				panelMuestraSustitucion);
		panelMuestraSustitucion.setLayout(panelMuestraSustitucionLayout);
		panelMuestraSustitucionLayout
				.setHorizontalGroup(panelMuestraSustitucionLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								panelMuestraSustitucionLayout
										...
										.addContainerGap()));
		panelMuestraSustitucionLayout
				.setVerticalGroup(panelMuestraSustitucionLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelMuestraSustitucionLayout
		...
		panelMetodoSustitucion.add(panelMuestraSustitucion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelDescripcionSustitucion.setBorder(null);
		panelDescripcionSustitucion
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDescripcionSustitucion
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		...
		panelMetodoSustitucion.add(panelDescripcionSustitucion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelResultadosSustitucion.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Resultados",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		contenedorResultadosSusBigramas
				.setViewportView(tablaResultadosSusBigramas);

		tablaResultadosSusTrigramas.setAutoCreateRowSorter(true);
		tablaResultadosSusTrigramas
				.setModel(new javax.swing.table.DefaultTableModel(
						new Object[][] { { null } },
						new String[] { "Resultados" }) {
					boolean[] canEdit = new boolean[] { false };
		...
		contenedorResultadosSusTrigramas
				.setViewportView(tablaResultadosSusTrigramas);

		javax.swing.GroupLayout panelResultadosSustitucionLayout = new javax.swing.GroupLayout(
				panelResultadosSustitucion);
		panelResultadosSustitucion.setLayout(panelResultadosSustitucionLayout);
		panelResultadosSustitucionLayout
				.setHorizontalGroup(panelResultadosSustitucionLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelResultadosSustitucionLayout
		...
		panelResultadosSustitucionLayout
				.setVerticalGroup(panelResultadosSustitucionLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelResultadosSustitucionLayout
		...
		panelMetodoSustitucion.add(panelResultadosSustitucion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonLimpiarSustitucion.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/reiniciar.png"))); // NOI18N
		botonLimpiarSustitucion.setToolTipText("Limpiar o reiniciar clave");
		botonLimpiarSustitucion
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		botonLimpiarSustitucion
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		panelMetodoSustitucion.add(botonLimpiarSustitucion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelAnalisisManualSustitucion.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Análisis manual",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N

		textoMasProbablesClavesSustitucionR.setFont(new java.awt.Font("Tahoma",
				1, 9));
		textoMasProbablesClavesSustitucionR
				.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		textoMasProbablesClavesSustitucionR.setBorder(javax.swing.BorderFactory
				.createEtchedBorder());
		...
		botonLimpiarSustitucionManual.setIcon(new javax.swing.ImageIcon(
				getClass().getResource("/images/reiniciar.png"))); // NOI18N
		botonLimpiarSustitucionManual
				.setToolTipText("Limpiar o reiniciar clave");
		botonLimpiarSustitucionManual
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		botonLimpiarSustitucionManual
				.addActionListener(new java.awt.event.ActionListener() {
		...
		javax.swing.GroupLayout panelAnalisisManualSustitucionLayout = new javax.swing.GroupLayout(
				panelAnalisisManualSustitucion);
		panelAnalisisManualSustitucion
				.setLayout(panelAnalisisManualSustitucionLayout);
		panelAnalisisManualSustitucionLayout
				.setHorizontalGroup(panelAnalisisManualSustitucionLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelAnalisisManualSustitucionLayout
		...
		panelAnalisisManualSustitucionLayout.linkSize(
				javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { labelSusManualD, labelSusManualM });

		panelAnalisisManualSustitucionLayout
				.setVerticalGroup(panelAnalisisManualSustitucionLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelAnalisisManualSustitucionLayout
		...
		panelAnalisisManualSustitucionLayout.linkSize(
				javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {
						claveSustitucionA, labelSusManualA });

		panelAnalisisManualSustitucionLayout.linkSize(
				javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {
						claveSustitucionB, claveSustitucionC,
						claveSustitucionD, claveSustitucionE,
						claveSustitucionF, claveSustitucionG,
						claveSustitucionH, claveSustitucionI, labelSusManualB,
						labelSusManualC, labelSusManualD, labelSusManualE,
						labelSusManualF, labelSusManualG, labelSusManualH,
						labelSusManualI });

		panelAnalisisManualSustitucionLayout.linkSize(
				javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {
						claveSustitucionJ, claveSustitucionK,
						claveSustitucionL, claveSustitucionM,
						claveSustitucionN, claveSustitucionO,
						claveSustitucionP, claveSustitucionQ,
						claveSustitucionR, labelSusManualJ, labelSusManualK,
						labelSusManualL, labelSusManualM, labelSusManualN,
						labelSusManualO, labelSusManualP, labelSusManualQ,
						labelSusManualR });

		panelAnalisisManualSustitucionLayout.linkSize(
				javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {
						claveSustitucionS, claveSustitucionT,
						claveSustitucionU, claveSustitucionV,
						claveSustitucionW, claveSustitucionX,
						claveSustitucionY, claveSustitucionZ, labelSusManualS,
						labelSusManualT, labelSusManualU, labelSusManualV,
						labelSusManualW, labelSusManualX, labelSusManualY,
						labelSusManualZ });

		panelAnalisisManualSustitucion.setBounds(395, 130, 370, 128);
		panelMetodoSustitucion.add(panelAnalisisManualSustitucion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMetodosClasicos.addTab("Sustitución", new javax.swing.ImageIcon(
				getClass().getResource("/images/clasico.png")),
				panelMetodoSustitucion); // NOI18N

		panelMetodoAffine.setName("affine"); // NOI18N

		botonClaveAffine.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/clave.png"))); // NOI18N
		...
		panelMetodoAffine.add(botonClaveAffine,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		...
		panelMetodoAffine.add(textoTipoCifradoAffine,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		...
		panelMetodoAffine.add(textoFuncionamientoAffine,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		...
		panelMetodoAffine.add(textoTipoCifradoAffineT,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		textoDescripcionAffine.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		textoDescripcionAffine
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		textoDescripcionAffine
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		...
		textoDescripcionAffineT
				.setText("Al cifrar, cada letra del texto plano es desplazada según la fórmula e(x) = (Ax+B) mod 26. El paso de texto cifrado a texto plano es realizado por CRIPTOANáLISIS.");
		textoDescripcionAffineT.setWrapStyleWord(true);
		textoDescripcionAffineT.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		...
		panelMetodoAffine.add(textoDescripcionAffine,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelClaveAffine.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Ingrese una clave como",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		textoAffineClave
				.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		textoAffineClave
				.setText("Una pareja (A.B) donde A debe ser primo relativo de 26");
		...
		javax.swing.GroupLayout panelClaveAffineLayout = new javax.swing.GroupLayout(
				panelClaveAffine);
		panelClaveAffine.setLayout(panelClaveAffineLayout);
		panelClaveAffineLayout
				.setHorizontalGroup(panelClaveAffineLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveAffineLayout
										...
										.addContainerGap()));
		panelClaveAffineLayout
				.setVerticalGroup(panelClaveAffineLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveAffineLayout
		...
		panelMetodoAffine.add(panelClaveAffine,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelDescripcionAffine.setBorder(null);
		panelDescripcionAffine
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDescripcionAffine
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		panelDescripcionAffine.setEnabled(false);
		panelDescripcionAffine
				.setPreferredSize(new java.awt.Dimension(370, 110));
		...
		cajaDescripcionAffine.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Descripción",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		panelMetodoAffine.add(panelDescripcionAffine,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelResultadosAffine.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Resultados",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		contenedorResultadoAffineLetras
				.setViewportView(tablaResultadosAffineLetras);

		tablaResultadosAffineBigramas.setAutoCreateRowSorter(true);
		tablaResultadosAffineBigramas
				.setModel(new javax.swing.table.DefaultTableModel(
						new Object[][] { { null } },
						new String[] { "Resultados" }) {
					boolean[] canEdit = new boolean[] { false };
		...
		contenedorResultadosAffineBigramas
				.setViewportView(tablaResultadosAffineBigramas);

		tablaResultadosAffineTrigramas.setAutoCreateRowSorter(true);
		tablaResultadosAffineTrigramas
				.setModel(new javax.swing.table.DefaultTableModel(
						new Object[][] { { null } },
						new String[] { "Resultados" }) {
					boolean[] canEdit = new boolean[] { false };
		...
		contenedorResultadosAffineTrigramas
				.setViewportView(tablaResultadosAffineTrigramas);

		textoMasProbablesClavesAffineR.setFont(new java.awt.Font("Tahoma", 1,
				11));
		textoMasProbablesClavesAffineR
				.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		textoMasProbablesClavesAffineR.setFocusable(false);
		textoMasProbablesClavesAffineR.setInheritsPopupMenu(false);

		textoMasProbablesClavesAffine
				.setText("Según el análisis de frecuencia las claves mas probables son:");
		...
		javax.swing.GroupLayout panelResultadosAffineLayout = new javax.swing.GroupLayout(
				panelResultadosAffine);
		panelResultadosAffine.setLayout(panelResultadosAffineLayout);
		panelResultadosAffineLayout
				.setHorizontalGroup(panelResultadosAffineLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelResultadosAffineLayout
														...
														.addGroup(
																panelResultadosAffineLayout
																		...
																		.addGap(7,
																				...
																				7)))));
		panelResultadosAffineLayout
				.setVerticalGroup(panelResultadosAffineLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
		...
		panelMetodoAffine.add(panelResultadosAffine,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonLimpiarAffine.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/reiniciar.png"))); // NOI18N
		...
		panelMetodoAffine.add(botonLimpiarAffine,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMetodosClasicos.addTab("Affine", new javax.swing.ImageIcon(
				getClass().getResource("/images/clasico.png")),
				panelMetodoAffine); // NOI18N

		panelMetodoVigenere.setName("vigenere"); // NOI18N

		botonClaveVigenere.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/clave.png"))); // NOI18N
		...
		panelMetodoVigenere.add(botonClaveVigenere,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		...
		panelMetodoVigenere.add(textoTipoCifradoVigenere,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		...
		panelMetodoVigenere.add(textoFuncionamientoVigenere,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		textoTipoCifradoVigenereT
				.setText("Polialfabético por sustitución (z26)");
		...
		panelMetodoVigenere.add(textoTipoCifradoVigenereT,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		textoDescripcionVigenere.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		textoDescripcionVigenere
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		textoDescripcionVigenere
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		...
		textoDescripcionVigenereT.setBackground(new java.awt.Color(232, 232,
				232));
		...
		textoDescripcionVigenereT
				.setText("Al cifrar, se sitúa la clave debajo del texto plano de manera repetitiva hasta cubrir su longitud, luego se suma cada columna. El paso de texto cifrado a plano se realiza por CRIPTOANáLISIS.");
		textoDescripcionVigenereT.setWrapStyleWord(true);
		textoDescripcionVigenereT.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		...
		panelMetodoVigenere.add(textoDescripcionVigenere,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelTipoClaveDesplazamiento1.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Ingrese una clave",
						javax.swing.border.TitledBorder.LEFT,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		javax.swing.GroupLayout panelTipoClaveDesplazamiento1Layout = new javax.swing.GroupLayout(
				panelTipoClaveDesplazamiento1);
		panelTipoClaveDesplazamiento1
				.setLayout(panelTipoClaveDesplazamiento1Layout);
		panelTipoClaveDesplazamiento1Layout
				.setHorizontalGroup(panelTipoClaveDesplazamiento1Layout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelTipoClaveDesplazamiento1Layout
										...
										.addContainerGap()));
		panelTipoClaveDesplazamiento1Layout
				.setVerticalGroup(panelTipoClaveDesplazamiento1Layout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelTipoClaveDesplazamiento1Layout
		...
		panelMetodoVigenere.add(panelTipoClaveDesplazamiento1,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelDescripcionVigenere.setBorder(null);
		panelDescripcionVigenere
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDescripcionVigenere
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		panelDescripcionVigenere.setEnabled(false);
		panelDescripcionVigenere.setPreferredSize(new java.awt.Dimension(370,
				110));

		cajaDescripcionVigenere
				.setBackground(new java.awt.Color(232, 232, 232));
		cajaDescripcionVigenere.setColumns(20);
		cajaDescripcionVigenere.setEditable(false);
		cajaDescripcionVigenere.setRows(4);
		cajaDescripcionVigenere.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Descripción",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		panelMetodoVigenere.add(panelDescripcionVigenere,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelResultadosVigenere.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Resultados",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		textoResultadoVigenereClave
				.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);

		javax.swing.GroupLayout panelResultadosVigenereLayout = new javax.swing.GroupLayout(
				panelResultadosVigenere);
		panelResultadosVigenere.setLayout(panelResultadosVigenereLayout);
		panelResultadosVigenereLayout
				.setHorizontalGroup(panelResultadosVigenereLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelResultadosVigenereLayout
														...
														.addGroup(
																panelResultadosVigenereLayout
																		...
																		.addGap(18,
																				...
																				18)
																		.addComponent(
																				textoResultadoVigenere)))
										.addContainerGap(33, Short.MAX_VALUE)));
		panelResultadosVigenereLayout
				.setVerticalGroup(panelResultadosVigenereLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelResultadosVigenereLayout
		...
		panelMetodoVigenere.add(panelResultadosVigenere,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonLimpiarVigenere.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/reiniciar.png"))); // NOI18N
		botonLimpiarVigenere.setToolTipText("Limpiar o reiniciar clave");
		botonLimpiarVigenere
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		botonLimpiarVigenere
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		panelMetodoVigenere.add(botonLimpiarVigenere,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMetodosClasicos.addTab("Vigenere", new javax.swing.ImageIcon(
				getClass().getResource("/images/clasico.png")),
				panelMetodoVigenere); // NOI18N

		panelMetodoHill.setName("hill"); // NOI18N

		infoHill.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/informacion.png"))); // NOI18N
		infoHill.setBounds(40, 200, 23, 23);
		panelMetodoHill.add(infoHill, javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonLimpiarHill.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/reiniciar.png"))); // NOI18N
		...
		panelMetodoHill.add(botonLimpiarHill,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonClaveHill.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/clave.png"))); // NOI18N
		...
		panelMetodoHill.add(botonClaveHill,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		...
		panelMetodoHill.add(textoTipoCifradoHill,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		...
		panelMetodoHill.add(textoFuncionamientoHill,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		...
		panelMetodoHill.add(textoTipoCifradoHillT,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		textoDescripcionHill.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		textoDescripcionHill
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		textoDescripcionHill
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		...
		textoDescripcionHillT
				.setText("Al cifrar, el texto plano es dividido en vectores de 1 por n, en donde n es el orden de la matriz clave, luego cada vector es multiplicado por la clave. El paso de texto cifrado a plano NO está disponible.");
		textoDescripcionHillT.setWrapStyleWord(true);
		textoDescripcionHillT.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		...
		panelMetodoHill.add(textoDescripcionHill,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		textoescripcion6.setBorder(javax.swing.BorderFactory.createLineBorder(
				new java.awt.Color(232, 232, 232), 0));
		textoescripcion6
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		textoescripcion6
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		...
		textoInfoHill
				.setText("La clave debe ser una matriz invertible y el MCD de su determinante y 26 debe ser 1");
		textoInfoHill.setWrapStyleWord(true);
		textoInfoHill.setBorder(javax.swing.BorderFactory.createLineBorder(
				new java.awt.Color(232, 232, 232), 0));
		...
		panelMetodoHill.add(textoescripcion6,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelDescripcionHillClave.setBorder(javax.swing.BorderFactory
				.createTitledBorder(""));
		panelDescripcionHillClave
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDescripcionHillClave
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		panelDescripcionHillClave.setEnabled(false);
		panelDescripcionHillClave.setPreferredSize(new java.awt.Dimension(370,
				110));

		cajaDescripcionHillClave
				.setBackground(new java.awt.Color(232, 232, 232));
		...
		panelMetodoHill.add(panelDescripcionHillClave,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelClaveHill.setBorder(javax.swing.BorderFactory.createTitledBorder(
				null, "Ingrese una clave",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		javax.swing.GroupLayout panelClaveHillLayout = new javax.swing.GroupLayout(
				panelClaveHill);
		panelClaveHill.setLayout(panelClaveHillLayout);
		panelClaveHillLayout
				.setHorizontalGroup(panelClaveHillLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveHillLayout
		...
		panelClaveHillLayout
				.linkSize(javax.swing.SwingConstants.HORIZONTAL,
						new java.awt.Component[] { claveHill4, claveHill5,
								claveHill6 });

		panelClaveHillLayout
				.setVerticalGroup(panelClaveHillLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveHillLayout
		...
		panelMetodoHill.add(panelClaveHill,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelDescripcionHill.setBorder(null);
		panelDescripcionHill
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDescripcionHill
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		...
		cajaDescripcionHill.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Descripción",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		panelMetodoHill.add(panelDescripcionHill,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMetodosClasicos
				.addTab("Hill", new javax.swing.ImageIcon(getClass()
						.getResource("/images/clasico.png")), panelMetodoHill); // NOI18N

		panelMetodoPermutacion.setName("permutacion"); // NOI18N
		panelMetodoPermutacion
		...
		botonLimpiarPermutacion.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/reiniciar.png"))); // NOI18N
		botonLimpiarPermutacion.setToolTipText("Limpiar o reiniciar clave");
		botonLimpiarPermutacion
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		botonLimpiarPermutacion
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		panelMetodoPermutacion.add(botonLimpiarPermutacion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonClavePermutacion.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/clave.png"))); // NOI18N
		botonClavePermutacion.setText("Generar una clave");
		botonClavePermutacion
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		panelMetodoPermutacion.add(botonClavePermutacion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		...
		panelMetodoPermutacion.add(textoTipoCifradoPermutacion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		...
		panelMetodoPermutacion.add(textoFuncionamientoPermutacion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		textoTipoCifradoPermutacionT
				.setText("Transposición / Permutación (z26)");
		...
		panelMetodoPermutacion.add(textoTipoCifradoPermutacionT,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		textoDescripcionPermutacion.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		textoDescripcionPermutacion
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		textoDescripcionPermutacion
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		...
		textoDescripcionPermutacionT.setBackground(new java.awt.Color(232, 232,
				232));
		textoDescripcionPermutacionT.setColumns(20);
		textoDescripcionPermutacionT.setEditable(false);
		textoDescripcionPermutacionT
				.setFont(new java.awt.Font("Tahoma", 0, 11));
		textoDescripcionPermutacionT.setLineWrap(true);
		textoDescripcionPermutacionT.setRows(5);
		textoDescripcionPermutacionT
				.setText("Al cifrar, el texto plano es separado en bloques del tamaño de la clave, luego cada bloque es reordenado según las posiciones que se indiquen en la clave. El paso de texto cifrado a plano NO está disponible.");
		textoDescripcionPermutacionT.setWrapStyleWord(true);
		textoDescripcionPermutacionT.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		...
		textoDescripcionPermutacion
				.setViewportView(textoDescripcionPermutacionT);

		textoDescripcionPermutacion.setBounds(220, 60, 430, 45);
		panelMetodoPermutacion.add(textoDescripcionPermutacion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelDescripcionPermutacion.setBorder(null);
		panelDescripcionPermutacion
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDescripcionPermutacion
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		panelDescripcionPermutacion.setEnabled(false);
		panelDescripcionPermutacion.setPreferredSize(new java.awt.Dimension(
				370, 110));

		cajaDescripcionPermutacion.setBackground(new java.awt.Color(232, 232,
				232));
		cajaDescripcionPermutacion.setColumns(20);
		cajaDescripcionPermutacion.setEditable(false);
		cajaDescripcionPermutacion.setRows(4);
		cajaDescripcionPermutacion.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Descripción",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		panelMetodoPermutacion.add(panelDescripcionPermutacion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMuestraPermutacion
				.setBorder(javax.swing.BorderFactory
						.createTitledBorder(
								null,
								"Ingrese la clave para reordenar cada bloque del texto plano",
								javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
								javax.swing.border.TitledBorder.DEFAULT_POSITION,
								new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		clavePermutacionAlternativa
				.setText("Usar doble cifrado y permutación por columnas");
		clavePermutacionAlternativa
				.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		clavePermutacionAlternativa
				.addActionListener(new java.awt.event.ActionListener() {
		...
		textoDescripcionPermutacion1.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		textoDescripcionPermutacion1
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		textoDescripcionPermutacion1
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		...
		textoDescripcionPermutacionT1.setBackground(new java.awt.Color(232,
				232, 232));
		textoDescripcionPermutacionT1.setColumns(20);
		textoDescripcionPermutacionT1.setEditable(false);
		textoDescripcionPermutacionT1
				.setFont(new java.awt.Font("Tahoma", 0, 11));
		textoDescripcionPermutacionT1.setLineWrap(true);
		textoDescripcionPermutacionT1.setRows(5);
		textoDescripcionPermutacionT1
				.setText("La clave debe ser un conjunto de números de 1 a n (con n menor a 9) en cualquier orden, en donde ninguno debe repetirse.");
		textoDescripcionPermutacionT1.setWrapStyleWord(true);
		textoDescripcionPermutacionT1.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		...
		textoDescripcionPermutacion1
				.setViewportView(textoDescripcionPermutacionT1);

		infoPermutacion.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/informacion.png"))); // NOI18N

		javax.swing.GroupLayout panelMuestraPermutacionLayout = new javax.swing.GroupLayout(
				panelMuestraPermutacion);
		panelMuestraPermutacion.setLayout(panelMuestraPermutacionLayout);
		panelMuestraPermutacionLayout
				.setHorizontalGroup(panelMuestraPermutacionLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								panelMuestraPermutacionLayout
										...
										.addGap(698, 698, 698)));
		panelMuestraPermutacionLayout
				.setVerticalGroup(panelMuestraPermutacionLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelMuestraPermutacionLayout
		...
		panelMetodoPermutacion.add(panelMuestraPermutacion,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMetodosClasicos.addTab("Permutación", new javax.swing.ImageIcon(
				getClass().getResource("/images/clasico.png")),
				panelMetodoPermutacion); // NOI18N

		panelMetodosClasicos.setBounds(0, 0, 780, 300);
		panelCifradoresClasicos.add(panelMetodosClasicos,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		panelMetodosClasicos.getAccessibleContext().setAccessibleName("");

		panelClasesCifrados.addTab("Cifradores Clásicos",
				panelCifradoresClasicos);
		...
		panelDetallesDESS.setBorder(javax.swing.BorderFactory.createLineBorder(
				new java.awt.Color(232, 232, 232), 0));
		panelDetallesDESS
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDetallesDESS
		...
		textoDetallesDESS.setBorder(javax.swing.BorderFactory.createLineBorder(
				new java.awt.Color(232, 232, 232), 0));
		...
		panelMetodoDESS.add(panelDetallesDESS,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		infoDESS.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/informacion.png"))); // NOI18N
		...
		cajaDescripcionDESS.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Descripción",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		panelMetodoDESS.add(panelDescripcionDESS,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonClaveDESS.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/clave.png"))); // NOI18N
		...
		panelMetodoDESS.add(botonClaveDESS,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonLimpiarDESS.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/reiniciar.png"))); // NOI18N
		...
		panelMetodoDESS.add(botonLimpiarDESS,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelClaveDESS.setBorder(javax.swing.BorderFactory.createTitledBorder(
				null, "Ingrese una clave",
				javax.swing.border.TitledBorder.LEFT,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		textoDescripcionDESS
				.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		textoDescripcionDESS
				.setText("en formato binario y de exactamente 10 bits");
		textoDescripcionDESS.setFocusable(false);
		textoDescripcionDESS.setInheritsPopupMenu(false);

		javax.swing.GroupLayout panelClaveDESSLayout = new javax.swing.GroupLayout(
				panelClaveDESS);
		panelClaveDESS.setLayout(panelClaveDESSLayout);
		panelClaveDESSLayout
				.setHorizontalGroup(panelClaveDESSLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveDESSLayout
										...
										.addContainerGap()));
		panelClaveDESSLayout
				.setVerticalGroup(panelClaveDESSLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveDESSLayout
		...
		panelMetodoDESS.add(panelClaveDESS,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		diagramaDESS.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		diagramaDESS.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/sdes.png"))); // NOI18N
		diagramaDESS
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		diagramaDESS.setBounds(400, 10, 360, 250);
		panelMetodoDESS.add(diagramaDESS,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMetodosBloque.addTab(
				"DES-Simplificado",
				new javax.swing.ImageIcon(getClass().getResource(
						"/images/bloque.png")), panelMetodoDESS); // NOI18N

		panelMetodoTripleDESS.setName("tsdes"); // NOI18N

		panelDetallesTripleDESS.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		panelDetallesTripleDESS
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDetallesTripleDESS
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		...
		textoDetallesTripleDESS.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		...
		panelMetodoTripleDESS.add(panelDetallesTripleDESS,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		infoTripleDESS.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/informacion.png"))); // NOI18N
		infoTripleDESS.setBounds(30, 30, 40, 60);
		panelMetodoTripleDESS.add(infoTripleDESS,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelDescripcionTripleDESS.setBorder(null);
		panelDescripcionTripleDESS
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDescripcionTripleDESS
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		panelDescripcionTripleDESS.setEnabled(false);
		panelDescripcionTripleDESS.setPreferredSize(new java.awt.Dimension(370,
				110));

		cajaDescripcionTripleDESS.setBackground(new java.awt.Color(232, 232,
				232));
		cajaDescripcionTripleDESS.setColumns(20);
		cajaDescripcionTripleDESS.setEditable(false);
		cajaDescripcionTripleDESS.setRows(4);
		cajaDescripcionTripleDESS.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Descripción",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		panelMetodoTripleDESS.add(panelDescripcionTripleDESS,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonClaveTripleDESS.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/clave.png"))); // NOI18N
		botonClaveTripleDESS.setText("Generar una clave");
		botonClaveTripleDESS
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		panelMetodoTripleDESS.add(botonClaveTripleDESS,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonLimpiarTripleDESS.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/reiniciar.png"))); // NOI18N
		botonLimpiarTripleDESS.setToolTipText("Limpiar o reiniciar clave");
		botonLimpiarTripleDESS
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		botonLimpiarTripleDESS
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		panelMetodoTripleDESS.add(botonLimpiarTripleDESS,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelClaveTripleDESS.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Ingrese una clave",
						javax.swing.border.TitledBorder.LEFT,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		textoDescripcionTripleDESS
				.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		textoDescripcionTripleDESS
				.setText("en formato binario y de exactamente 30 bits");
		textoDescripcionTripleDESS.setFocusable(false);
		textoDescripcionTripleDESS.setInheritsPopupMenu(false);

		javax.swing.GroupLayout panelClaveTripleDESSLayout = new javax.swing.GroupLayout(
				panelClaveTripleDESS);
		panelClaveTripleDESS.setLayout(panelClaveTripleDESSLayout);
		panelClaveTripleDESSLayout
				.setHorizontalGroup(panelClaveTripleDESSLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveTripleDESSLayout
										...
										.addContainerGap()));
		panelClaveTripleDESSLayout
				.setVerticalGroup(panelClaveTripleDESSLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveTripleDESSLayout
		...
		panelMetodoTripleDESS.add(panelClaveTripleDESS,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		diagramaTripleDESS
				.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		diagramaTripleDESS.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/3sdes.png"))); // NOI18N
		diagramaTripleDESS
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		diagramaTripleDESS.setBounds(400, 10, 360, 250);
		panelMetodoTripleDESS.add(diagramaTripleDESS,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMetodosBloque.addTab(
				"Triple DES-Simplificado",
				new javax.swing.ImageIcon(getClass().getResource(
						"/images/bloque.png")), panelMetodoTripleDESS); // NOI18N

		panelMetodoDES.setName("des"); // NOI18N

		panelDetallesDES.setBorder(javax.swing.BorderFactory.createLineBorder(
				new java.awt.Color(232, 232, 232), 0));
		panelDetallesDES
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDetallesDES
		...
		textoDetallesDES.setBorder(javax.swing.BorderFactory.createLineBorder(
				new java.awt.Color(232, 232, 232), 0));
		...
		panelMetodoDES.add(panelDetallesDES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		infoDES.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/informacion.png"))); // NOI18N
		...
		cajaDescripcionDES.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Descripción",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		panelMetodoDES.add(panelDescripcionDES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonClaveDES.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/clave.png"))); // NOI18N
		...
		panelMetodoDES.add(botonClaveDES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonLimpiarDES.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/reiniciar.png"))); // NOI18N
		...
		panelMetodoDES.add(botonLimpiarDES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelClaveDES.setBorder(javax.swing.BorderFactory.createTitledBorder(
				null, "Ingrese una clave",
				javax.swing.border.TitledBorder.LEFT,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		textoDescripcionDES
				.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		textoDescripcionDES
				.setText("en formato hexadecimal y de exactamente 16 dígitos");
		textoDescripcionDES.setFocusable(false);
		textoDescripcionDES.setInheritsPopupMenu(false);

		javax.swing.GroupLayout panelClaveDESLayout = new javax.swing.GroupLayout(
				panelClaveDES);
		panelClaveDES.setLayout(panelClaveDESLayout);
		panelClaveDESLayout
				.setHorizontalGroup(panelClaveDESLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveDESLayout
										...
										.addContainerGap()));
		panelClaveDESLayout
				.setVerticalGroup(panelClaveDESLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveDESLayout
		...
		panelMetodoDES.add(panelClaveDES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		diagramaDES.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		diagramaDES.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/des.png"))); // NOI18N
		diagramaDES
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		diagramaDES.setBounds(400, 10, 360, 250);
		panelMetodoDES.add(diagramaDES, javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMetodosBloque.addTab("DES", new javax.swing.ImageIcon(getClass()
				.getResource("/images/bloque.png")), panelMetodoDES); // NOI18N

		panelMetodoTDES.setName("tdes"); // NOI18N

		panelDetallesTDES.setBorder(javax.swing.BorderFactory.createLineBorder(
				new java.awt.Color(232, 232, 232), 0));
		panelDetallesTDES
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDetallesTDES
		...
		textoDetallesTDES.setBorder(javax.swing.BorderFactory.createLineBorder(
				new java.awt.Color(232, 232, 232), 0));
		...
		panelMetodoTDES.add(panelDetallesTDES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		infoTDES.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/informacion.png"))); // NOI18N
		...
		cajaDescripcionTDES.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Descripción",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		panelMetodoTDES.add(panelDescripcionTDES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonClaveTDES.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/clave.png"))); // NOI18N
		...
		panelMetodoTDES.add(botonClaveTDES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonLimpiarTDES.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/reiniciar.png"))); // NOI18N
		...
		panelMetodoTDES.add(botonLimpiarTDES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelClaveTDES.setBorder(javax.swing.BorderFactory.createTitledBorder(
				null, "Ingrese una clave",
				javax.swing.border.TitledBorder.LEFT,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		textoDescripcionTDES
				.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		textoDescripcionTDES
				.setText("en formato hexadecimal y de exactamente 48 dígitos");
		textoDescripcionTDES.setFocusable(false);
		textoDescripcionTDES.setInheritsPopupMenu(false);

		javax.swing.GroupLayout panelClaveTDESLayout = new javax.swing.GroupLayout(
				panelClaveTDES);
		panelClaveTDES.setLayout(panelClaveTDESLayout);
		panelClaveTDESLayout
				.setHorizontalGroup(panelClaveTDESLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								panelClaveTDESLayout
										...
										.addContainerGap()));
		panelClaveTDESLayout
				.setVerticalGroup(panelClaveTDESLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveTDESLayout
		...
		panelMetodoTDES.add(panelClaveTDES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		diagramaTDES.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		diagramaTDES.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/3des.png"))); // NOI18N
		diagramaTDES
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		diagramaTDES.setBounds(400, 10, 360, 250);
		panelMetodoTDES.add(diagramaTDES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMetodosBloque.addTab("Triple DES", new javax.swing.ImageIcon(
				getClass().getResource("/images/bloque.png")), panelMetodoTDES); // NOI18N

		panelMetodoAES.setName("aes"); // NOI18N

		panelDetallesAES.setBorder(javax.swing.BorderFactory.createLineBorder(
				new java.awt.Color(232, 232, 232), 0));
		panelDetallesAES
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDetallesAES
		...
		textoDetallesAES
				.setText("El paso de texto cifrado a plano se realiza por \nDESCIFRADO.");
		textoDetallesAES.setWrapStyleWord(true);
		textoDetallesAES.setBorder(javax.swing.BorderFactory.createLineBorder(
				new java.awt.Color(232, 232, 232), 0));
		...
		panelMetodoAES.add(panelDetallesAES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		infoAES.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/informacion.png"))); // NOI18N
		...
		cajaDescripcionAES.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Descripción",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		panelMetodoAES.add(panelDescripcionAES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonClaveAES.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/clave.png"))); // NOI18N
		...
		panelMetodoAES.add(botonClaveAES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonLimpiarAES.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/reiniciar.png"))); // NOI18N
		...
		panelMetodoAES.add(botonLimpiarAES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelClaveAES.setBorder(javax.swing.BorderFactory.createTitledBorder(
				null, "Ingrese una clave",
				javax.swing.border.TitledBorder.LEFT,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		javax.swing.GroupLayout panelClaveAESLayout = new javax.swing.GroupLayout(
				panelClaveAES);
		panelClaveAES.setLayout(panelClaveAESLayout);
		panelClaveAESLayout
				.setHorizontalGroup(panelClaveAESLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveAESLayout
										...
										.addContainerGap()));
		panelClaveAESLayout
				.setVerticalGroup(panelClaveAESLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveAESLayout
		...
		panelMetodoAES.add(panelClaveAES,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		diagramaAES.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		diagramaAES.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/aes.png"))); // NOI18N
		diagramaAES
				.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		diagramaAES.setBounds(400, 10, 360, 250);
		panelMetodoAES.add(diagramaAES, javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMetodosBloque.addTab("AES", new javax.swing.ImageIcon(getClass()
				.getResource("/images/bloque.png")), panelMetodoAES); // NOI18N

		panelMetodosSPN.setBackground(new java.awt.Color(232, 232, 232));
		panelMetodosSPN.setName("spn"); // NOI18N

		panelDetallesSPN.setBorder(javax.swing.BorderFactory.createLineBorder(
				new java.awt.Color(232, 232, 232), 0));
		panelDetallesSPN
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDetallesSPN
		...
		textoDetallesSPN1
				.setText("Como se utilizan únicamente bloques de 4 bits para representar cada letra del alfabeto inglés, solo serán tomadas las letras de la A a la P. Los demás carácteres se eliminarán del texto y de la clave al ser procesados.\nEl CRIPTOANáLISIS solo se realiza para cadenas de 4 carácteres a través de una aproximación lineal.\n");
		textoDetallesSPN1.setWrapStyleWord(true);
		textoDetallesSPN1.setBorder(javax.swing.BorderFactory.createLineBorder(
				new java.awt.Color(232, 232, 232), 0));
		...
		panelMetodosSPN.add(panelDetallesSPN,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		infoSPN.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
		infoSPN.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/informacion.png"))); // NOI18N
		...
		cajaDescripcionSPN.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Descripción",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		panelMetodosSPN.add(panelDescripcionSPN,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonClaveSPN.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/clave.png"))); // NOI18N
		...
		panelMetodosSPN.add(botonClaveSPN,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonLimpiarSPN.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/reiniciar.png"))); // NOI18N
		...
		panelMetodosSPN.add(botonLimpiarSPN,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelClaveSPN.setBorder(javax.swing.BorderFactory.createTitledBorder(
				null, "Ingrese", javax.swing.border.TitledBorder.LEFT,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		javax.swing.GroupLayout panelClaveSPNLayout = new javax.swing.GroupLayout(
				panelClaveSPN);
		panelClaveSPN.setLayout(panelClaveSPNLayout);
		panelClaveSPNLayout
				.setHorizontalGroup(panelClaveSPNLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								panelClaveSPNLayout
										...
										.addContainerGap()));
		panelClaveSPNLayout
				.setVerticalGroup(panelClaveSPNLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveSPNLayout
		...
		panelMetodosSPN.add(panelClaveSPN,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelCriptoanalisis.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Aproximación lineal",
						javax.swing.border.TitledBorder.LEFT,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		javax.swing.GroupLayout panelCriptoanalisisLayout = new javax.swing.GroupLayout(
				panelCriptoanalisis);
		panelCriptoanalisis.setLayout(panelCriptoanalisisLayout);
		panelCriptoanalisisLayout
				.setHorizontalGroup(panelCriptoanalisisLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelCriptoanalisisLayout
		...
		panelCriptoanalisisLayout
				.setVerticalGroup(panelCriptoanalisisLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelCriptoanalisisLayout
		...
		panelMetodosSPN.add(panelCriptoanalisis,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		parejasPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(
				null, "", javax.swing.border.TitledBorder.LEFT,
				javax.swing.border.TitledBorder.DEFAULT_POSITION));

		botonMuestrasSPN.setFont(new java.awt.Font("DejaVu Sans", 0, 11));
		botonMuestrasSPN.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/bloc.png"))); // NOI18N
		botonMuestrasSPN
				.setText("Generar n parejas texto plano - texto cifrado");
		...
		javax.swing.GroupLayout parejasPanelLayout = new javax.swing.GroupLayout(
				parejasPanel);
		parejasPanel.setLayout(parejasPanelLayout);
		parejasPanelLayout
				.setHorizontalGroup(parejasPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								parejasPanelLayout
										...
										.addGap(3, 3, 3)));
		parejasPanelLayout
				.setVerticalGroup(parejasPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								parejasPanelLayout
		...
		panelMetodosSPN.add(parejasPanel,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMetodosBloque.addTab("SPN", new javax.swing.ImageIcon(getClass()
				.getResource("/images/bloque.png")), panelMetodosSPN); // NOI18N

		panelMetodoCBCMAC.setName("cbcmac"); // NOI18N

		muestraCBCMAC.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/cbcmac.png"))); // NOI18N
		muestraCBCMAC.setBounds(420, 10, 330, 250);
		panelMetodoCBCMAC.add(muestraCBCMAC,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		infoCBCMAC.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/informacion.png"))); // NOI18N
		infoCBCMAC.setBounds(30, 40, 40, 40);
		panelMetodoCBCMAC.add(infoCBCMAC,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonClaveCBCMAC.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/clave.png"))); // NOI18N
		...
		panelMetodoCBCMAC.add(botonClaveCBCMAC,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonLimpiarCBCMAC.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/reiniciar.png"))); // NOI18N
		...
		panelMetodoCBCMAC.add(botonLimpiarCBCMAC,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelClaveCBCMAC.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Ingrese una clave",
						javax.swing.border.TitledBorder.LEFT,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		javax.swing.GroupLayout panelClaveCBCMACLayout = new javax.swing.GroupLayout(
				panelClaveCBCMAC);
		panelClaveCBCMAC.setLayout(panelClaveCBCMACLayout);
		panelClaveCBCMACLayout
				.setHorizontalGroup(panelClaveCBCMACLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveCBCMACLayout
										...
										.addContainerGap()));
		panelClaveCBCMACLayout
				.setVerticalGroup(panelClaveCBCMACLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveCBCMACLayout
		...
		panelMetodoCBCMAC.add(panelClaveCBCMAC,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelDetallesCBCMAC.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		panelDetallesCBCMAC
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDetallesCBCMAC
		...
		textoDetallesCBCMAC
				.setText("Se utilizan bloques de 8 bits para representar cada letra del alfabeto inglés. Para este algoritmo se toma t=8 y n como la cantidad de letras del texto plano.");
		textoDetallesCBCMAC.setWrapStyleWord(true);
		textoDetallesCBCMAC.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(232, 232, 232), 0));
		...
		panelMetodoCBCMAC.add(panelDetallesCBCMAC,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelDescripcionCBCMAC.setBorder(null);
		panelDescripcionCBCMAC
				.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		panelDescripcionCBCMAC
				.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
		...
		cajaDescripcionCBCMAC.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Descripción",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		panelMetodoCBCMAC.add(panelDescripcionCBCMAC,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMetodosBloque.addTab("CBC-MAC", new javax.swing.ImageIcon(
				getClass().getResource("/images/bloque.png")),
				panelMetodoCBCMAC); // NOI18N

		panelMetodosBloque.setBounds(0, 0, 780, 300);
		panelCifradoresBloque.add(panelMetodosBloque,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		panelMetodosBloque.getAccessibleContext().setAccessibleName(
				"Triple DES-Simplificado");

		panelClasesCifrados.addTab("Cifradores de Bloque",
				panelCifradoresBloque);
		...
		panelClaveRSAab.setBorder(javax.swing.BorderFactory.createTitledBorder(
				null, "Ingrese",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		javax.swing.GroupLayout panelClaveRSAabLayout = new javax.swing.GroupLayout(
				panelClaveRSAab);
		panelClaveRSAab.setLayout(panelClaveRSAabLayout);
		panelClaveRSAabLayout
				.setHorizontalGroup(panelClaveRSAabLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveRSAabLayout
										...
										.addContainerGap()));
		panelClaveRSAabLayout
				.setVerticalGroup(panelClaveRSAabLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveRSAabLayout
		...
		panelClaveRSAabLayout.linkSize(javax.swing.SwingConstants.VERTICAL,
				new java.awt.Component[] { cajaClaveRSAd, tipoClaveRSAd });

		panelClaveRSAabLayout.linkSize(javax.swing.SwingConstants.VERTICAL,
				new java.awt.Component[] { cajaClaveRSAe, tipoClaveRSAe });

		panelClaveRSAab.setBounds(10, 150, -1, 87);
		panelMetodoRSA.add(panelClaveRSAab,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelClaveRSAnpq.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Ingrese",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("DejaVu Sans", 0, 11))); // NOI18N
		...
		javax.swing.GroupLayout panelClaveRSAnpqLayout = new javax.swing.GroupLayout(
				panelClaveRSAnpq);
		panelClaveRSAnpq.setLayout(panelClaveRSAnpqLayout);
		panelClaveRSAnpqLayout
				.setHorizontalGroup(panelClaveRSAnpqLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
		...
		panelClaveRSAnpqLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { tipoClaveRSAn, tipoClaveRSApq });

		panelClaveRSAnpqLayout
				.setVerticalGroup(panelClaveRSAnpqLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelClaveRSAnpqLayout
		...
		panelClaveRSAnpqLayout.linkSize(javax.swing.SwingConstants.VERTICAL,
				new java.awt.Component[] { cajaClaveRSAp, cajaClaveRSAq,
						tipoClaveRSApq });

		panelClaveRSAnpq.setBounds(10, 35, 500, 115);
		panelMetodoRSA.add(panelClaveRSAnpq,
				javax.swing.JLayeredPane.DEFAULT_LAYER);
		...
		panelMetodoRSA.add(tipoOptimizacionRSA,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonLimpiarRSA.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/images/reiniciar.png"))); // NOI18N
		...
		panelMetodoRSA.add(botonLimpiarRSA,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		botonClaveRSA.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/clave.png"))); // NOI18N
		...
		panelMetodoRSA.add(botonClaveRSA,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		diagramaRSA.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		diagramaRSA.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/images/RSA.png"))); // NOI18N
		diagramaRSA.setBounds(530, 20, 230, 240);
		panelMetodoRSA.add(diagramaRSA, javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelMetodosPublicos.addTab("RSA", new javax.swing.ImageIcon(getClass()
				.getResource("/images/clasico.png")), panelMetodoRSA); // NOI18N

		panelMetodosPublicos.setBounds(0, 0, 780, 300);
		panelCifradoresPublicos.add(panelMetodosPublicos,
				javax.swing.JLayeredPane.DEFAULT_LAYER);

		panelClasesCifrados.addTab("Cifradores de Clave Pública",
				panelCifradoresPublicos);
		...
		layout.setHorizontalGroup(layout
				...
				.addComponent(panelContenido,
						javax.swing.GroupLayout.PREFERRED_SIZE, 798,
						javax.swing.GroupLayout.PREFERRED_SIZE)
				.addGroup(
						layout.createSequentialGroup()
								.addContainerGap()
								.addComponent(panelClasesCifrados,
										javax.swing.GroupLayout.DEFAULT_SIZE,
		...
		layout.setVerticalGroup(layout
				...
				.addGroup(
						layout.createSequentialGroup()
								...
								.addComponent(panelClasesCifrados,
										javax.swing.GroupLayout.DEFAULT_SIZE,
										330, Short.MAX_VALUE).addContainerGap()));
